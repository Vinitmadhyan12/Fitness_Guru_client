...
import { validation } from "../utils/ChangeValidation";
import { useParams } from "react-router-dom";
import { ToastContainer, toast } from 'react-toastify';



const ChangePassword = ({ currUser, setCurrUser }) => {
    const [user, setUser] = useState({ username: currUser.username, oldpassword: "", newpassword: "" });
    ...
    const handlesubmit = async (e) => {
        ...
        if (errors.username === "" && errors.oldpassword === "" && errors.newpassword === "") {
            ...
            setUser({ username: currUser.username, oldpassword: "", newpassword: "" })
        }
    }
    return (
        <div className=" flex justify-center bg-gray-400 w-full h-[633px] overflow-hidden text-center text-lg text-gray-100 font-inter">
            ...
            <form action="" className="absolute left-[460px]">
